from views.frame.Admin import gui_product, gui_storage, gui_ncc, gui_employees, gui_accounts, gui_bill, gui_reports
from views.frame.User import gui_product2, gui_storage2, gui_bill2
from views.frame.Admin.Attendance import gui_attendance

frame = None

def attendance(window):
    show_frame(window, gui_attendance)
...
def account(window):
    show_frame(window, gui_accounts)
