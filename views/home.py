...
label = Label(frame_menu, text=f"  WELCOME  \n (Quản Lý)", font=("Times New Roman", 18, "bold"), fg="#000000", bg="#cfe8ff", anchor="center")
...
buttons.extend([
    ...
    Button(frame_menu, text="Điểm danh", font=("Times New Roman", 12),command=lambda: fr.attendance(window)),
    Button(frame_menu, text="Hóa đơn", font=("Times New Roman", 12), command=lambda: fr.bill(window)),
    Button(frame_menu, text="Thống kê", font=("Times New Roman", 12), command=lambda: fr.report(window)),
])
func.size(buttons)
