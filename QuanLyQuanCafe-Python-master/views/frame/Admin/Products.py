...
#...
    ...
    btn_img = Button(frame, text="Thêm ảnh", bg="#0099FF", fg="white", width = 12, font=("Times New Roman", 11, "bold"))
    btn_img.place(x=600, y=320, height=35)

#Label
    label_1 = Label(frame, text="Quản Lý Sản Phẩm", font=("Times New Roman", 20, "bold"), fg="#000000", bg="white")
    label_1.place(x=30, y=25)

    Label(frame, text="Mã sản phẩm", font=("Times New Roman", 14), bg="white").place(x=30, y=180)
    entry_id = Entry(frame, width=28)
    entry_id.place(x=30, y=210, height=25)

    Label(frame, text="Tên sản phẩm", font=("Times New Roman", 14), bg="white").place(x=300, y=180)
    entry_name = Entry(frame, width=28)
    entry_name.place(x=300, y=210, height=25)

    Label(frame, text="Đơn giá", font=("Times New Roman", 14), bg="white").place(x=600, y=180)
    ...
    entry_ncc = Entry(frame, width=35)
    entry_ncc.place(x=900, y=210, height=25)

    Label(frame, text="Phân loại", font=("Times New Roman", 14), bg="white").place(x=30, y=280)
