...
#Label
    label_1 = Label(frame, text="Quản Lý Tài Khoản", font=("Times New Roman", 20, "bold"), fg="#000000", bg="white")
    label_1.place(x=30, y=25)

    Label(frame, text="ID", font=("Times New Roman", 14), bg="white").place(x=30, y=180)
    entry_id = Entry(frame, width=28)
    entry_id.place(x=30, y=210, height=25)

    Label(frame, text="Tên tài khoản", font=("Times New Roman", 14), bg="white").place(x=300, y=180)
    ...
    Label(frame, text="Mật khẩu", font=("Times New Roman", 14), bg="white").place(x=30, y=280)
    entry_type = Entry(frame, width=20)
    entry_type.place(x=30, y=320, height=25)

    Label(frame, text="Vai trò", font=("Times New Roman", 14), bg="white").place(x=300, y=280)
