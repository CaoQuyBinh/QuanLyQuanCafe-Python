...
#Label
    ...
    Label(frame, text="Số điẹn thoại", font=("Times New Roman", 14), bg="white").place(x=30, y=280)
    entry_type = Entry(frame, width=20)
    entry_type.place(x=30, y=320, height=25)

    Label(frame, text="Mã sản phẩm", font=("Times New Roman", 14), bg="white").place(x=300, y=280)
